...
def main():
    ...
    optimizer_lambda = APGD([{'params': model.lamda}], alpha=HP_train.alpha, device=device, lr=HP_train.lambda_lr, momentum=0.9, weight_decay=0.0001, nesterov=True)
