...
def main():
    ...
    # model = base_LCNet(num_classes=16, n_neuron=32, n_mobileunit=10).to(device)  # alpha =0
    # model = Std_LCNet(num_classes=16, n_neuron=32, n_mobileunit=7).to(device)  # alpha =0
